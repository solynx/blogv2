...
<template>
  ...
  <footer
    class="relative z-10 bg-white dark:bg-dark pt-20 pb-10 lg:pt-[120px] lg:pb-20 w-full"
  >
        ...
        <div class="w-full px-4 sm:w-2/3 lg:w-3/12">
          <div class="w-full mb-10">
            <a
              ...
              class="mb-6 inline-block max-w-[80px] w-full h-full"
            >
              <img
                src="https://api.dicebear.com/8.x/adventurer/svg?seed=Boo"
                alt="avatar"
                class="max-w-full"
              />
            </a>
            <p class="text-base text-body-color dark:text-dark-6 mb-7">
              The boy is green hair
            </p>
            <p
